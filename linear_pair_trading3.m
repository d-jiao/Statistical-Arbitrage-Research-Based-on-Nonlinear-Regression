...
y = [0.2, 5 / 3];
plot(x, y, 'b')
scatter([1.5, 1.5, 1.5, 2, 2, 1, 1], [5/3, 1.3, 1, 4/3, 1.3 + 1/3, 2/3, 1.3 - 1/3], 'k.')
x = [1.5, 1.5];
y = [5/3, 1];
plot(x, y, '--')
...
plot([1.95 2], [1.3 1.3] + 1/3, '-k')
plot([1.95 2], [1 1] + 1/3, '-k')

plot([0.95 1], [1.3 1.3] - 1/3, '-k')
plot([0.95 1], [1 1] - 1/3, '-k')

plot([1 1], [0 2/3 + 0.3], '--')
plot([2 2], [0 4/3 + 0.3], '--')
annotation('doublearrow', [0.51 0.51], [1.3 + 5/144, 5/3 - 5/144] / 2.5, 'Head1Length', 5, 'Head1Width', 5, 'Head2Length', 5, 'Head2Width', 5, 'Units', 'points')
annotation('doublearrow', [0.51 0.51], [1.3 + 5/144, 1 + 5/55] / 2.5, 'Head1Length', 5, 'Head1Width', 5, 'Head2Length', 5, 'Head2Width', 5, 'Units', 'points')

annotation('doublearrow', [0.64 0.64], [1.3 + 5/144, 1 + 5/55] / 2.5 + 0.11, 'Head1Length', 5, 'Head1Width', 5, 'Head2Length', 5, 'Head2Width', 5, 'Units', 'points')
annotation('doublearrow', [0.38 0.38], [1.3 + 5/144, 1 + 5/55] / 2.5 - 0.11, 'Head1Length', 5, 'Head1Width', 5, 'Head2Length', 5, 'Head2Width', 5, 'Units', 'points')
...
text(1.4, 1.75, '$V_{A0}$','FontName','Times New Roman', 'Interpreter', 'latex')

text(2, 1.2 + 1/3, '$V_{A2}$','FontName','Times New Roman', 'Interpreter', 'latex')
text(2, 0.85 + 1/3, '$V_{B2}$','FontName','Times New Roman', 'Interpreter', 'latex')

text(1, 1.2 - 1/3, '$V_{A1}$','FontName','Times New Roman', 'Interpreter', 'latex')
...
text(1.89, (1 + 1.3)/2 + 1/3, '$t_{0}$','FontName','Times New Roman', 'Interpreter', 'latex')
text(0.89, (1 + 1.3)/2 - 1/3, '$t_{0}$','FontName','Times New Roman', 'Interpreter', 'latex')
